...
from .quantity import extract_error, extract_units, extract_value, extract_conduct_value
import logging
...
class BaseParser(object):
    ...
    def extract_conduct_value(self, string):
        """
        Extract conductivity values
        :param jj:
        :return:
        """
        return extract_conduct_value(string)
