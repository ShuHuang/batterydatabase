...
units = (((((W('mAh') | W('Ah')) | ((W('mA') | W('A')) +
                                    W('h'))) +
           R(r'^k?g[\-–−]1$'))) | (((W('mAh') | W('Ah')) | ((W('mA') | W('A')) +
                                                            W('h'))) +
                                   W('/') +
                                   (W('kg') | W('g'))))('units').add_action(merge)
...
capa_specifier = (Optional(I('reversible')) +
                  Optional((I('charge') +
                            I('and') +
                            I('discharge')) | (I('discharge') +
                                               I('and') +
                                               I('charge')) | I('discharge') | I('charge')) +
...
current_units = (((W('mA') | W('A')) +
                  R(r'^k?g[\-–−]1$')) | ((W('mA') | W('A')) +
                                         W('/') +
                                         W('g')) | I('C'))('units').add_action(merge)
current_and_units = (
    Optional(lbrct).hide() +
    capa +
    current_units +
...
current_specifier = Optional(I('current')) + \
    Optional(I('density') | I('rate') | I('densities'))
current_prefix = (
    Optional('for').hide() +
    Optional(
        I('at')).hide() +
    ...
    Optional(
                I('of') | I('about') | I('from') | I('approximately') | I('around') | (
                    I('high') +
                    I('as')) | (
                        I('higher') | I('lower') +
                    I('than'))).hide())
...
cycle_prefix = (
    Optional(
        I('at') | I('after') | I('of') | I('during') | I('in')) +
    Optional(
        I('the'))).hide()
cycle = Optional(cycle_prefix) + cycle_and_units

capa_and_units = (Optional(lbrct).hide() + capa + units + Optional(rbrct).hide()
                  )('capa') + Optional(current) + Optional(cycle) + Optional(current)

capa_specifier_and_value = Optional(prefix) + (Optional(delim).hide() + Optional(lbrct | I('[')).hide(
) + capa + units + Optional(rbrct | I(']')).hide())('capa') + Optional(current) + Optional(cycle) + Optional(current)
...
cem_prefix_value = (Optional(current) + Optional(cycle) + Optional(current)
